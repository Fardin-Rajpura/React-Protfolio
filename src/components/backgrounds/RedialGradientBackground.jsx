...
const RedialGradientBackground = ({ variant = 'hero', gradient = [] }) => {
  ...
  const activeGradient = variant === 'custom' ? gradient : variants[variant] || variants.hero;

  const generateGradient = (colors) => {
    const colorStops = colors.map(({ colors, stop }) => `${colors} ${stop}`).join(', ');
