            ...
            <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20'>
                    ...
                    <div className='flex flex-col gap-12'>
                        <div className='flex flex-col gap-8'>
                            ...
                            <FadeIn delay={60}>
                                <div className='inline-flex items-center gap-2.5 px-5 py-2.5 border border-primary/30 bg-primary/10 rounded-full w-fit'>
                                    ...
                                    <span className='text-sm text-primary font-medium tracking-[2px]'>
                            ...
                            <FadeIn delay={100}>
                                <h2 className='text-4xl lg:text-5xl font-normal text-white leading-tight'>
                                    Crafting Digital Expriances That Matter
                                </h2>
                            </FadeIn>
                            ...
                            <FadeIn delay={200}>
                                <div className='flex flex-col gap-4'>
                                    {PERSONAL_INFO.bio.map((paragraph, index) => (
                                        <p key={index} className='text-base text-white/70  leading-relaxed tracking-[0.5px]'>
                                            {paragraph}
                                        </p>
                                    ))}
                                </div>
                        ...
                        <FadeIn delay={300}>
                            <div className='grid grid-cols-3 gap-8 ps-3'>
                                    ...
                                    <div className='flex items-start gap-4'>
                                        ...
                                        <div className='flex-1'>
                                            ...
                                            <p className='text-sm text-white/70 leading-relaxed'>
                                                Specilized in building scalabel web application width modern technologis and best practices.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className='flex flex-col items-center gap-8'>
                        <div className='text-center'>
                            ...
                            <p className='text-sm text-white/60'>
                                Technology I work with to build amazing produts.
                            </p>
                        </div>
