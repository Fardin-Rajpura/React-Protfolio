    ...
    return (
        ...
        >
            ...
            <div className='absolute inset-0 overflow-hidden'>
                ...
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary/20 opacity-30 rounded-full blur-3xl'></div>
            </div>
                        ...
                        <div className='space-y-8'>
                            ...
                            <div className='space-y-4'>
                                <div className='group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                    ...
                                    <div className='absolute inset-0 bg-linear-to-br from-primary/0 to-priamry/0 group-hover:from-priamry/5 group-hover:to-priamry/5 rounded-2xl transition-all duration-all pointer-events-none'></div>
                                </div>
                                ...
                                {Object.entries(SOCIAL_LINKS).slice(0, 3).map(([platform, url]) => {
                                    ...
                                    return Icon ? (
                                        <a
                                            ...
                                            className='p-4 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 hover:border-primary/10 hover:scale-110 transition-all duration-300 group'
                                        >
                                            <Icon className='w-6 h-6 text-white/60 group-hover:text-primary transiton-colors' />
                                        </a>
                                    ) : null;
                                })}
                            </div>
