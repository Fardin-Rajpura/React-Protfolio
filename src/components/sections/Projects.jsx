    ...
    return (
        ...
        >
            ...
            <div className='absolute inset-0 overflow-hidden'>
                ...
                <div className='absolute top-1/2 right-1/3 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl'></div>
            </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className='relative flex items-center gap-2'>
                                        ...
                                        <span className='text-sm tracking-[0.2px]'>
                                            {category}
                                        </span>
                                    </div>
                        ...
                        >
                            ...
                            <div className='flex gap-6 pb-4'>
                                ...
                                {filteredProjects.map((project) => (
                                    ...
                                    <div
                                        key={project.id}
                                        className='project-card w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] shrink-0 snap-start'
                                    >
