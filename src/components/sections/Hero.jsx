...
const Hero = () => {
  return (
    <section className='relative min-h-screen flex items-center overflow-hidden bg-black'>
      ...
      {/*Content container*/}
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px6 lg:px-8 py-20 w-full'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          {/*Left Column Content */}

          <div className='text-left'>
            <FadeIn delay={0}>
              <div className='inline-flex items-center gap-2.5 px-[18px] py-[11px] mb-8 bg-linear-to-r from-primary/10 via-primary/15 border border-primary/20 rounded-full'>
          ...
          {/*Right Column Content Developer Image*/}

          <FadeIn delay={200}>
            <div className='relative'>
              <div className='relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group'>
                <div className='absolute inset-0 rounded-2xl overflow-hidden'>
                  <div className='absolute inset-0 bg-gradient-to-r from-primary/20 via-primary/20 to-primary animate-[spin_5s_linear_infinite] rounded-2xl'></div>
                </div>
                ...
                <div className='absolute bottom-6 left-6 z-20'>
                  <FadeIn delay={500}>
                    <div className='flex items-center gap-4 bg-black/40 backdrop-blur-sm rounded-full px-6 py-3 border border-white/10'>
