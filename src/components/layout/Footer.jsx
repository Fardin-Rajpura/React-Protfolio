  ...
  return (
    <section className='relative bg-black overflow-hidden border-t border-white/10'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        <div className='absolute top-0 left-1/2 w-96 h-96 bg-primary/10 opacity-30 rounded-full blur-3xl'></div>
                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    ...
                    >
                      ...
                      <div className='absolute inset-0 bg-gradient-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl transition-all duration-300 pointer-events-none'></div>
                    </a>
                  ) : null;
                })}
              </div>
