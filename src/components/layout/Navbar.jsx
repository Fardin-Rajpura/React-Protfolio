...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-100 w-full py-4 transition-all duration-300 ${isScrolled
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-4 text-2xl font-bold'>
            ...
            <button
              ...
              className='text-primary font-bold bg-gradient-to-r from-primary via-primary/50 to-primary/30 bg-clip-text text-transparent hover:opacity-80 transition-opacity'
              aria-label='home'
            >
          ...
          <nav className='hidden md:flex items-center gap-6'>
            {NAV_LINKS.map((link) => (
              <button
                ...
                className={`px-4 py-2 rounded-md transition-colors duration-300 ${activeSection === link.id
                  ? 'text-white'
          ...
          <div className='hidden md:flex items-center gap-2'>
            <button onClick={() => handleNavClick('contact')}
              className='px-4 py-2 bg-white text-[#212121] font-medium text-base rounded-[17px] border border-white  hover:bg-white/90 transition-all duration-300'
            >
              Hire Me
            </button>
          </div>
